<%@ page import="database.RawMartBean" %>
<%@ page import="database.RawMartMain" %>
            ...
            <a href="#">
              <div class="media">
                ...
                <div class="media-body">
                  <h5 class="media-heading"><strong>${pageContext.request.userPrincipal.name}</strong>
                  </h5>
      ...
      <!-- <div class="row">
         ...
         <div class="col-lg-3 col-md-6">
           <div class="panel panel-red">
             ...
             <a href="#">
               <div class="panel-footer">
                 <span class="pull-left">Vendor Details</span>
          ...
          <div class="panel-body">
            <div class="table-responsive">
              <table class="table table-bordered table-hover table-striped">
                ...
                <tbody>
                <%
                  List<RawMartBean> rawData = new RawMartMain().getData();
                  Iterator<RawMartBean> iterator = rawData.iterator();
                  int rowCount = 0;
                  while (iterator.hasNext()){
                  %>
                <tr>
                  <td><%=rawData.get(rowCount).getId()%></td>
                  <td><a href="#"><%=rawData.get(rowCount).getName()%></a></td>
                  <td><%=rawData.get(rowCount).getContactNo()%></td>
                  <td><%=rawData.get(rowCount).getEmailId()%></td>
                </tr>
                <%
                    iterator.next();
                    rowCount++;
